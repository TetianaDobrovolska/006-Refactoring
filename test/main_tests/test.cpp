...
{
	ChessFigure *figure = new RookFigureType("E2");
...
{
	ChessFigure *figure = new KnightFigureType("B1");
...
{
	ChessFigure *figure = new BishopFigureType("C1");
...
{
	ChessFigure* figure = new PawnFigureType("E2");
	EXPECT_TRUE(figure->Move("E3"));
}
...
{
	ChessFigure *figure = new PawnFigureType("E4");
...
{
	ChessFigure* figure = new KingFigureType("E1");
...
{
	ChessFigure* figure = new QueenFigureType("D1");
