...
{
	ChessFigure *figure = new ChessFigure(new RookFigure(),"E2");
...
{
	ChessFigure *figure = new ChessFigure(new KnightFigure(), "B1");
...
{
	ChessFigure *figure = new ChessFigure(new BishopFigure(), "C1");
...
{
	ChessFigure* figure = new ChessFigure(new PawnFigure(), "E2");
	EXPECT_TRUE(figure->Move("E3"));
}
...
{
	ChessFigure *figure = new ChessFigure(new PawnFigure(), "E4");
...
{
	ChessFigure* figure = new ChessFigure(new KingFigure(), "E1");
...
{
	ChessFigure* figure = new ChessFigure(new QueenFigure(), "D1");
